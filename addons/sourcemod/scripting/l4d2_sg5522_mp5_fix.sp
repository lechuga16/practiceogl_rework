...
{
	name = "[L4D2] SG552/MP5 Reload Fix",
	author = "McFlurry",
	description = "Fixes the reload time of SG552/MP5 - edit by lechuga",
...
public OnPluginStart()
{
	...
	CreateConVar("l4d2_sg552fix_version", PLUGIN_VERSION, "Installed version of SG552 Reload Fix on this server", FCVAR_NOTIFY|FCVAR_DONTRECORD|FCVAR_REPLICATED);
